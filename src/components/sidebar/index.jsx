...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      className={`absolute left-0 z-[9999] flex h-screen w-56 flex-col overflow-y-hidden duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
        ...
        <button
          ...
          className="block lg:hidden bg-zinc-800 fill-white border-2 border-white rounded-3xl p-1 my-3 ml-2 w-fit"
        >
          <GoX
      ...
      <div className="bg-white h-screen overflow-y-auto">
        ...
        <div className="flex flex-col duration-300 ease-linear">
          ...
          <nav className="py-3 px-1">
            {/* <!-- Menu Group --> */}
            <div>
              <h3 className="my-2 ml-4 text-sm font-semibold text-bodydark2">
                HOME
              </h3>

              <ul className="mb-6 flex flex-col gap-1 mx-3 text-sm">
                {[1].map(item=>(
                  <>
                                  {/* <!-- Menu Item Dashboard --> */}
                <SidebarLinkGroup
                      ...
                      <>
                        <NavLink
                          ...
                          className={`group relative flex items-center gap-2 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                            ...
                            "bg-slate-50 border-gray-300 border-2 dark:bg-meta-4"
                          }`}
                          onClick={(e) => {
                            e.preventDefault();
                            handleClick();
